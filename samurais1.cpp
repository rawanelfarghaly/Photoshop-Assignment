...
enum enFilter {
	grayscale = 2, Black_and_white = 3, Invert_images = 4, merge_2_images = 5, Flip_image = 6, Rotate_the_image = 7, darken_and_lighten_image = 8, Crop_image = 9, Adding_a_frame_to_the_photo = 10, detect_edges = 11, Resize_image = 12, Blur_Image = 13, Purple_Wano = 15, Infrared_photography = 16
};
