...
//20242165 : Filter 3: Invert images, Filter 6: Rotate image, 9: Adding a frame to the picture, 12: Blur image, 15: Infrared photography
//20242068 : Filter 1: gray scale, Filter 4: merge 2 images, Filter:7 darken and lighten image,Filter 12:detect edges, Filter13: Sunlight
...
enum enFilter {
	grayscale = 2, Black_and_white = 3, Invert_images = 4, merge_2_images = 5, Flip_image = 6, Rotate_the_image = 7, darken_and_lighten_image = 8, Crop_image = 9, Adding_a_frame_to_the_photo = 10, detect_edges = 11, Resize_image = 12, Blur_Image = 13, Purple_Wano = 15, Infrared_photography = 16, Sunlight = 13
};
...
void sunlight(Image& img, string& filename)
{
	int width = img.width;
